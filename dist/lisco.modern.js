...
class Server {
  ...
  loadRoutes(app, routes) {
    ...
    for (const route of routes) {
      ...
      let router = route.configure(); //perform autoconfig for base api crud operations
...
async function Runtime(extra) {
  ...
  const argv = cfg.argv; //Parámetro para no arrancar el servidor y generar las claves JWT
